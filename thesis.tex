...
\title{Plataforma de reportería automatizada para gestión de esfuerzos en proyectos de desarrollo de software basados en metodologías ágiles}
\author{Sebastián González Mardones}

\begin{document}

\selectlanguage{spanish}

\profguia{Cecilia Reyes Cobarrubias}
